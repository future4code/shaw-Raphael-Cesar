...
import { ContestInfo, ContestInfoContainer, ContestInfoMobile, HomeContainer, LeftSide, LotoContainer, NumberContainer, NumberDiv, RightSide, Select } from "./Styled"
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const currentLottery = lotto.find((lottery) => lottery.nome === selectController)
    ...
    return (
        ...
        >
            ...
            <RightSide>
                ...
                <p>Este sorteio é meramente ilustrativo.</p>
            </RightSide>
        </HomeContainer>
    )
}
